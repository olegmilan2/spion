...
const LOCATION_DIFFICULTY_POOLS = {
  ...
  sport: {
    easy: ['Арена', 'Манеж', 'Корт', 'Стадион', 'Трек', 'Трибуна', 'Бассейн', 'Ринг', 'Старт', 'Финиш', 'Турнир', 'Кубок', 'Разминка', 'Сектор', 'Скамейка'],
  ...
  history: {
    easy: ['Музей', 'Архив', 'Фонд', 'Галерея', 'Крепость', 'Летопись', 'Реликвия', 'Манускрипт', 'Витрина', 'Экспозиция', 'Каталог', 'Коллекция', 'Раскопки', 'Павильон', 'Экспонат'],
